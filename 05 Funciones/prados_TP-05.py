...
celsius = float(input("Ingrese los grados que desea convertir a farenheit\n"))
...
a = float(input("Ingrese la nota 1 \n"))
b = float(input("Ingrese la nota 2 \n"))
c = float(input("Ingrese la nota 3 \n"))
